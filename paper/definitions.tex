...
%\todo[inline]{AK: this is a new section}
\todo[inline]{AK: I'm still working on this section, don't read it =)}
...
\label{alg:ca}
\hspace*{\algorithmicindent} \textbf{Input:} hierarchical graph $HG(V,E)$, Eulerian solution $D$.\\
