...
\todo[inline]{AK: Sasha G., should we make this is a list of advantages? 1) it is more flexible; 2) it solves special case; 3) it is easier to prove 2-approximability}
