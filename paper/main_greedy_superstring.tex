...
\todo[inline]{Sasha G, think about a good example highlighting all properties of this algorithm. In particular, it should highlight the lines 8--11 of the algorithm. The same example should be used for the collapsing algorithm.}
