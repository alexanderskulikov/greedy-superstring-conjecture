...
%}
\end{mypic}
\caption{Stages of applying the Collapsing Algorithm to the dataset $\mathcal{S}=\{{\tt aaa}, {\tt cae}, {\tt aec}, {\tt eee}\}$ and its optimal solution. (a)~We start by doubling every edge of the optimal solution from Figure~\ref{fig:hgex}(c). 
